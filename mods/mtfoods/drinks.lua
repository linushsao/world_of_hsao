...
minetest.register_craft({
    ...
    recipe = {
        {'default:stick','mtfoods:apple_cider','default:stick'},
        {'default:wood','mtfoods:apple_cider','default:wood'},
    }
})

minetest.register_craftitem("mtfoods:bottle_cap", {
			description = "Bottle Cap",
			inventory_image = "mtfoods_bottle_cap.png",
})

minetest.register_craft({
    output = "mtfoods:bottle_cap 5",
    recipe = {
        {'moreores:tin_ingot'},
