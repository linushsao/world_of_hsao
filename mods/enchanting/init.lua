...
minetest.register_craft({
        ...
        recipe = {
                {'""','""','""','""','""'},
        {'"default:obsidian"','"default:diamond"','"enchanting:enchanted_pick_diamond_durability"','"default:diamond"','"default:obsidian"'},
                {'""','""','""','""','""'}
        }
})
...
minetest.register_craft({
        ...
        recipe = {
                {'""','""','""','""','""'},
        {'"default:obsidian"','"default:steel_ingot"','"enchanting:enchanted_pick_steel_durability"','"default:steel_ingot"','"default:obsidian"'},
                {'""','""','""','""','""'}
        }
})
...
-- linus // standard weapon repair

minetest.register_craft({
        output = '"default:pick_diamond"',
        recipe = {
                {'""','""','""','""','""'},
        {'""','"default:diamond"','"default:pick_diamond"','"default:obsidian"','""'},
                {'""','""','""','""','""'}
        }
})
minetest.register_craft({
        ...
        recipe = {
                {'""','""','""','""','""'},
        {'""','"default:steel_ingot"','"default:pick_steel"','"default:obsidian"','""'},
                {'""','""','""','""','""'}
        }
})

minetest.register_craft({
        output = '"walking_light:light_halmet"',
        recipe = {
                {'""','""','""','""','""'},
        {'""','"default:wood"','"walking_light:light_halmet"','"default:obsidian"','""'},
                {'""','""','""','""','""'}
        }
})
